...
function GenerateImages() {
  const imageStyle=[
      'Realistic','Ghibli style','Anime style','Cartoon style','Fantasy style','Realistic style','3D style','Portraid style',
    ]
    ...
    const onSubmitHandler = async (e)=>{
      ...
      try {
        setLoading(true);
        const prompt=`Generate an image with the description "${input}" in ${selectedStyle} style. `;
